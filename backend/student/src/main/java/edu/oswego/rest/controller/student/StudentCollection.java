...
public class StudentCollection {
    ...
    @POST
    public Response postStudent(String payload) {
    ...
    @POST
    @Path("/delete/{userId}")
    public Response deleteSpecificStudent(@PathParam("userId") int userId){
        //TODO This method needs to ensure authentication
        try {
            Student student = studentService.findOne(userId);
    ...
    public Response getAssignReviewForTeams(@PathParam("userId") int userId, @PathParam("assignmentId") int assignmentId) {
    ...
    public Response getResultAssignmentsByStudent(@PathParam("userId") int userId){
        //TODO This method needs to ensure authentication
    ...
    public Response getResultByAssignmentIdAndStudentID(@PathParam("userId") int userId,@PathParam("assignmentId") int assignmentId) {
        Assignment assignment = assignmentService.findOne(assignmentId);
    ...
    public Response getAssignmentsByStudent(@PathParam("userId") int userId){
        //TODO This method needs to ensure authentication
        List<Course> courses = courseService.findCoursesByStudent_UserID(userId);
        JSONArray listOfCoursesJSON = new JSONArray();
        for(Course course : courses)
    ...
    public Response getStudentsAndTeamsByStudent(@PathParam("userId") int userId){
        //TODO This method needs to ensure authentication
    ...
    @GET
    @Path("/{userId}/course/{courseId}/teamId") // Student
    public Response getTeamIDByUserID(@PathParam("userId") int userId,@PathParam("courseId") int courseId){
    ...
    @Path("/testAuth") // For student
    public Response testAuth(@HeaderParam("authorization") String token, String payload)  {
//        authObject aObject = new authObject();
//        String role = aObject.returnRole(token);
        return new ResponseMessage().sendMessage(payload,200);
    }
