...
public class csvImport {
    ...
    @POST
    public Response parse(String payload) throws ClassNotFoundException, JsonProcessingException { //receive json array from frontEnd. Ask John for exact input if unsure

        JSONObject obj = new JSONObject(payload);
        JSONObject courseJSON = obj.getJSONObject("course");

        int numberOfTeams = obj.getInt("numberOfTeams");
        JSONArray studentsJSON = obj.getJSONArray("csvContents");  //json array of csv contents
